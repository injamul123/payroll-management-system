  ...
  <table width="442" border="1" align="center">
    ...
    <tr>
      ...
      <td width="200"><div align="center">
        <input name="Emp_id" type="text" id="Emp_id" required>
      </div></td>
    </tr>
    <tr>
      <td><div align="center">Employee Name </div></td>
      <td><div align="center">
        <input name="EmpName" type="text" id="EmpName" required>
      </div></td>
    </tr>
    <tr>
      <td><div align="center">Designation</div></td>
      <td><div align="center">
        <input name="Designation" type="text" id="Designation" required>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div align="center">
          ...
          <select name="EmpGrade" id="EmpGrade" required>
