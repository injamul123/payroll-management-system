...
{    
	...
	$rs=mysqli_query($con,"select * from salary where pdeptname='$DeptName'");
	echo"<form name='form1' method='post' action=''>
</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width='86%' height='68'  border='1'bgcolor='#CCFFFF'>
    <tr>
